...
Another way to distribute the data is to use a parallel source. Using this source Renoir will create a number of replicas of the source and execute them in parallel.
